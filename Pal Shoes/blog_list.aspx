<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blog_list.aspx.cs" Inherits="blog_list" %>
                ...
                <h3><span>Brand</span></h3>
                        ...
                        <div class="col-md-9 col-sm-8">
                            ...
                            <div class="product-listing">
                                <div class="row">
                                    <asp:Label ID="lblBlogList" runat="server" Text=""></asp:Label>
                                    <asp:Repeater ID="rpBlogList" runat="server">
                                        <ItemTemplate>
                                            <div class="col-xs-12">
                                                <div class="shop-list-view">
                                                    <div class="product-item">
                                                        <div class="product-image">
                                                            <a href="#">
                                                                <asp:Image ID="complogo" runat="server" ImageUrl='<%# Eval("imagefile","../Upload/blog/{0}") %>' Width="600px" Height="180px" alt="" />
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="product-item-details">
                                                        <div class="product-item-name">
                                                            <a href="#"><%#Eval("Blogtitle") %></a>
                                                        </div>
                                                        ...
                                                        <div class="detail-inner-left">
                                                            <ul>
                                                                <li class="pro-cart-icon">
                                                                    <a href='blog_description.aspx?blogid=<%# Eval("Blogid") %>'>
                                                                        <h3 style="font-weight: 600;">Details </b></h3>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
