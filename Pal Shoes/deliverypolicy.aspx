<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deliverypolicy.aspx.cs" Inherits="deliverypolicy" %>
...
<body>
          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <div class="container">
                <div class="bread-crumb mtb-30 center-xs">
                    <div class="page-title">DELIVERY POLICY&nbsp;</div>
                    <div class="bread-crumb-inner right-side float-none-xs">
                        <ul>
                            <li><a href="Default.aspx">Home</a><i class="fa fa-angle-right"></i></li>
                            <li><span>Deliviery Policy</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h1></h1>
          <p>Our Delivery Policies includes all important points keeping in our customer satisfaction & convenience in mind:</p>
          <ol>
          <li>Prices for delivery and methods of delivery available (standard, express, overnight, etc.).</li>
          <li>Orders of 4000 or above will qualify our fast free shipping offer.</li>
          <li>We deliver PAN India in all territories with all its range of destinations.</li>
          <li>Palshoes is GST registered company. According to the general rule of GST. It will be payable at delivery charges where it is payable on the product.</li>
          <li>Our Free shipping with the standard ground package will be within 3-5 working days & Paid shipping with the express package will be within 2-3 working days.</li>
          </ol>
        </div>
      </div>
      <div class="about-detail mt-40">
        <div class="row">
          <div class="col-sm-4 mb-xs-30">
            <div class="image-part"> <img alt="" src="images/delivery policy.jpg"/> </div>
          </div>
          <div class="col-sm-8">
            <ol start="6">
            <li>Delivery Problems may occur sometimes, whether caused by any reason - can be dealt with either in T&C of sale or a legally-enforceable delivery policy.</li>
             <li>All parcels can be tracked and a shipment form with all your tracking information will be sent to you once the order is dispatched.<br /><br /></li>
             <li><b>IMPORTANT POINTS:</b>
             <ol type="i">
                <li>Orders placed after 12:00 on working days will be shipped the next following day.</li>
                <li>Delivery times specified above may not be applicable if there are any complications in Delivering parcel.</li>
                <li>Orders placed on weekends will be shipped on Monday ( applicable if that Monday should not fall as any Public Holiday).</li>
            </ol>
            </li>
            </ol>
          </div>
