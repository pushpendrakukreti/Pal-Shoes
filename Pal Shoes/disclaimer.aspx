    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          ...
          <p>Palshoes website content and information provided to customers is provided for informational purposes only. Such information is not intended to diagnose, treat, cure, or prevent disease or to provide medical advice. Nor is it intended to replace a relationship with a health care provider. Nutrition information on this website represents the opinions of the respective authors and is protected under the laws of copyright and trademark.</p>
          <p>No statement on our website is intended to imply that supplements can or should be used in place of a drug or medication or that supplements can cure, treat, or prevent disease. Any questions you may have concerning your use of drugs, medications, or supplements should be directed to your healthcare professional.</p>
        </div>
      </div>
      <div class="about-detail mt-40">
        <div class="row">
          ...
          <div class="col-sm-8">
            <p>While the administrators of the Palshoes.com Company and website recognize the complications that can arise as a result of side effects experienced by consumers ordering products from our website, we also recognize the realities of modern day drug abuse. While we know that health complications and dependence resulting from ingesting products reviewed on this site can lead to improper and unsupervised use, we have no control over purchases that are misused by shoppers who use proper identification to buy merchandise displayed and reviewed on this site.</p>
            <div class="heading-part align_left center-md">
              <h2 class="heading mt-30">LEGAL DISCLAIMER</h2>
            </div>
            <p>Any of the related business entities do not provide any warranty or guarantees for the products and services provided on behalf of all our suppliers and their brands, other than as it is related to product replacement for an incorrect order or replacement or refund for a product which may be damaged or considered faulty.</p>
            <p>At all times you should rely on your own inquiries as to the accuracy of any information about products or services made available on this website.</p>
          </div>
        </div>
      </div>
    </div>
