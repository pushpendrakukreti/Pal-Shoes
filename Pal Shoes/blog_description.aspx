<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blog_description.aspx.cs" Inherits="blog_description" %>
        ...
        <div class="main">
            ...
            <div class="container">
                <div class="bread-crumb mtb-30 center-xs">
                    <div class="page-title">Blog Details</div>
                                    ...
                                    <ItemTemplate>
                                        <div class="col-xs-12 mb-60">
                                            <div class="blog-media">
                                                <asp:Image ID="complogo" runat="server" ImageUrl='<%# Eval("imagefile","../Upload/blog/{0}") %>' />
                                            </div>
