<%@ Page Language="C#" AutoEventWireup="true" CodeFile="motivation-video.aspx.cs" Inherits="motivation_video" %>
          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <div class="container">
                <div class="bread-crumb mtb-30 center-xs">
                    <div class="page-title">Motivation Video</div>
                    <div class="bread-crumb-inner right-side float-none-xs">
                        <ul>
                            <li><a href="Default.aspx">Home</a><i class="fa fa-angle-right"></i></li>
                            <li><span>Motivation Video</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 mb-30">
         <div class="media-body vplayer">
           <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
            <asp:DataList ID="rtPlayVideos" RepeatColumns="3" RepeatDirection="Horizontal" RepeatLayout="Flow" runat="server">
            <ItemTemplate>
            <div class="viditem">
              <iframe id="ytplayer" src="http://www.youtube.com/embed/<%# Eval("videourlid") %>"
               height="auto" width="100%" frameborder="0" allowfullscreen></iframe>
            </div>
           </ItemTemplate>
           </asp:DataList>
           </div>
