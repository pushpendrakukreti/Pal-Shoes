<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="Addnewevent.aspx.cs" Inherits="admin_Addnewevent" %>
...
<tr>
 ...
 <tr>
   <td>Event Title: :</td>
   <td>
       <asp:TextBox ID="txtEventtitle" runat="server" Width="220px"></asp:TextBox>&nbsp;
       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
           ErrorMessage="Event Title*" ControlToValidate="txtEventtitle" Display="Dynamic" 
 ...
 <td></td>
 <td>
     <asp:Button ID="btnAddEvent" runat="server" Text="Add Event" OnClick="btnAddEvent_Click" ValidationGroup="g1" />
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
