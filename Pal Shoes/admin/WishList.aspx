<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="WishList.aspx.cs" Inherits="admin_WishList" %>
...
.mGrid td { padding: 4px; border: solid 1px #c1c1c1; color: #717171;font-size: 14px; }
...
.mGrid td:nth-child(1){width:8%;}
.mGrid td:nth-child(2){width:14%;}
.mGrid td:nth-child(3){width:10%;}
.mGrid td:nth-child(4){width:25%;}
.mGrid td:nth-child(5){width:14%;}
.mGrid td:nth-child(6){width:20%;}
.mGrid td:nth-child(7){width:10%;}
...
<p class="text-center"><asp:Label ID="lblMessage" runat="server" Text=""></asp:Label></p>
    ...
    <asp:GridView ID="gvWishlist" runat="server" GridLines="None" 
        ...
        <Columns>
            ...
            <ItemTemplate>
                <asp:Image ID="Image1" ImageUrl='<%#Eval("Thumbnail", "../Upload/thumbnails/{0}") %>' Height="50" Width="50" runat="server" />
            </ItemTemplate>
            </asp:TemplateField>
