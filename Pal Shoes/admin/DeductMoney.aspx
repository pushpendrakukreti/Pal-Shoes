<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="DeductMoney.aspx.cs" Inherits="admin_DeductMoney" %>
    ...
    <div class="col-lg-6 col-md-8 col-sm-8 col-lg-offset-3 col-sm-offset-2">
        ...
        <div class="row">
            ...
            <div class="heading-part heading-bg">
                <h2 class="heading">Deduct Money From Wallet</h2>
            </div>
