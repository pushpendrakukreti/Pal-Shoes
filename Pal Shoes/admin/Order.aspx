<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="admin_Order" %>
...
.product td:nth-child(2){ width:24%;}
.product td:nth-child(3){ width:14%;}
.product td:nth-child(4){ width:16%;}
.product td:nth-child(5){ width:4%;}
.product td:nth-child(6){ width:12%;}

table.product1{ margin:0; padding:0; width:100%;}
.product1 td{ padding:0px; vertical-align:middle; text-align:left; border-bottom:solid 1px #666; color:#666;}
.product1 td:nth-child(1){ width:10%;}
.product1 td:nth-child(2){ width:24%;}
.product1 td:nth-child(3){ width:14%;}
.product1 td:nth-child(4){ width:16%;}
.product1 td:nth-child(5){ width:4%;}
.product1 td:nth-child(6){ width:12%;}
...
<div style=" margin:0 auto; padding:0; width:95%;">
    ...
    <a href="SalesDetails.aspx" style="text-decoration:none; color:Blue; font-weight:bold;">Back</a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td colspan="4">
        ...
        <hr />
          <p class="text-center">
              ...
              Shipping Charges : <asp:Label ID="lblShipping" runat="server" Text=""></asp:Label></p>

        <%--<p class="text-center">Shipping Charges : <%#Eval("FinalShippingCharges") %></p>--%>

        <div style="text-align:right; color:Black; padding-right:10%; height:30px; padding:5px;">

        HSN Code (9506) : GST (12%) = <asp:Label ID="lblGSTPrice" runat="server" Text=""></asp:Label>  
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />
