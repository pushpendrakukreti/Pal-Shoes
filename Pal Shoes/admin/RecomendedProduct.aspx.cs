...
public partial class admin_RecomendedProduct : System.Web.UI.Page
{
    ...
    private void BindWishlist()
    {
        try
        {
            ...
            dt = local_order.getRecomendedProduct();
            if (dt.Rows.Count > 0)
            {
    ...
    protected void DeleteRecord(object sender, EventArgs e)
    {
        try
        {
            ...
            if (success != 0)
            {
                ...
                lblMessage.Text = "Recomended Product Deleted Successfully";
            }
            else
            {
                lblMessage.ForeColor = Color.Red;
                lblMessage.Text = "Recomended Product Delete Failed";
            }
        }
        catch (Exception ex)
        {
