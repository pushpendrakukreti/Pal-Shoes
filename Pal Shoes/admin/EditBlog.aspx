<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="EditBlog.aspx.cs" Inherits="admin_EditBlog" %>
...
<asp:GridView ID="gvBlog" runat="server" AutoGenerateColumns="False" 
        ...
        GridLines="None" AllowPaging="true" onrowcommand="gvBlog_RowCommand" 
        onrowdeleting="gvBlog_RowDeleting1">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Blog Photo">
                <ItemTemplate>
                    <asp:Image ID="Image1" ImageUrl='<%# Eval("imagefile","../Upload/blog/{0}") %>' Height="100px" Width="300px" runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="Blogtitle" HeaderText="Blog Title" />
            <asp:BoundField DataField="Blogbody" HeaderText="Blog Description" />
            <asp:BoundField DataField="BlogDate" HeaderText="Blog Date" />
            <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CommandName="Edit" CommandArgument='<%#Eval("Blogid") %>'></asp:Button>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                    <asp:Button ID="btnDelete" runat="server" Text="Delete" CommandArgument='<%#Eval("Blogid") %>' 
