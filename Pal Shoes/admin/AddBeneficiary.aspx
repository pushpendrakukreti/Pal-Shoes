<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="AddBeneficiary.aspx.cs" Inherits="admin_AddBeneficiary" %>
    ...
    <div class="col-lg-6 col-md-8 col-sm-8 col-lg-offset-3 col-sm-offset-2">
        ...
        <div class="row">
            ...
            <div class="heading-part heading-bg">
                <h2 class="heading">Add Beneficiary Account</h2>
            </div>
            ...
            <br />
            <div class="input-box">
                <label for="f-name">Name (Ac Beneficiary Name)</label>
                <asp:TextBox ID="txtNameBene" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ErrorMessage="* Beneficiary Name" ControlToValidate="txtNameBene" Display="Dynamic" 
            ...
            <br />
            <div class="input-box">
                <label for="f-name">Account Number</label>
                <asp:TextBox ID="txtAccountno" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                 ErrorMessage="* Account Number" ControlToValidate="txtAccountno" Display="Dynamic" 
                    ValidationGroup="g1" ForeColor="Red"></asp:RequiredFieldValidator>
                <cc1:FilteredTextBoxExtender runat="server" ID="FilteredTextBoxExtender2" TargetControlID="txtAccountno"
                     FilterType="Custom" Enabled="true" FilterMode="ValidChars" ValidChars="1234567890">
                </cc1:FilteredTextBoxExtender>
            </div>
            </div>
            ...
            <br />
            <div class="input-box">
                <label for="f-name">IFSC Code</label>
            ...
            <div class="col-xs-12">
            <br />
            <p class="text-center"><asp:LinkButton ID="linkBeneficiary" onclick="linkBeneficiary_Click" runat="server"><big><u><b>Transfer Amount To Customer</b></u></big></asp:LinkButton></p>
            </div>
