<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" Culture="en-GB" AutoEventWireup="true" CodeFile="WalletDetails.aspx.cs" Inherits="admin_WalletDetails" %>
...
<div class="minheight">
<h3 class="text-center">User Wallet Details</h3>
<table class="ord">
    <tr>
    <td>
    ...
    <p class="text-center">
        ...
        CssClass="mGrid" PagerStyle-CssClass="pgr" AllowPaging="true" 
         ...
         PageSize="5" onpageindexchanging="gvWalletDetails_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField DataField="DeductedAmount" HeaderText="Deducted" />
