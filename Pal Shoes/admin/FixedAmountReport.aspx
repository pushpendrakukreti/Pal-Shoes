<%@ Page Title="" Language="C#" Culture="en-GB" MasterPageFile="~/admin/AdminPage.master" AutoEventWireup="true" CodeFile="FixedAmountReport.aspx.cs" Inherits="admin_FixedAmountReport" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <asp:GridView ID="gvWalletDetails" runat="server" GridLines="None" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FixAmount" HeaderText="Fix Amount" />
            <asp:BoundField DataField="NoOfday" HeaderText="No Of days" />
            <asp:BoundField DataField="CalcAmount" HeaderText="Calc Amount" />
