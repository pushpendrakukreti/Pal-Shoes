<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPage.master" Culture="en-GB" AutoEventWireup="true" CodeFile="AddtoWallet.aspx.cs" Inherits="AddtoWallet" %>
...
<div class="minheight">
<h3 class="text-center">Add/Deduct Amount to Wallet</h3>
 <table class="ord">
    <tr>
    <td>
    ...
    <asp:GridView ID="gvRegistration" runat="server" GridLines="None" 
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:ImageButton ID="BtnAddMoney" ImageUrl="~/img/Addmoney.png" CommandName="Add Money"
                    CommandArgument='<%# Eval("UserId") %>' Width="73px" runat="server"></asp:ImageButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:ImageButton ID="BtnDeductMoney" ImageUrl="~/img/Deductmoney.png" CommandName="Deduct Money"
                    CommandArgument='<%# Eval("UserId") %>' Width="77px" runat="server"></asp:ImageButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
