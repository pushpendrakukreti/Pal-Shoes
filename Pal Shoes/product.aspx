      ...
      <div class="container">
        <div class="header-top-inner">
          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <%--<li class="level"><a href="motivation-video.aspx" class="page-scroll">Videos</a></li>--%>
    ...
    <ContentTemplate>
      <div class="row">
            ...
            <div class="sidebar-box filter-sidebar mb-40">
              ...
              <div class="sidebar-contant">
                ...
                <div class="filter-inner-box mb-20">
                 ...
                 <%--<asp:CheckBoxList CssClass="chk" ID="CheckBoxList1" runat="server" AutoPostBack="True" onselectedindexchanged="CheckBoxList1_SelectedIndexChanged1"></asp:CheckBoxList>--%>
                  <%--<ul id="brd">
        ...
        <div class="col-md-9 col-sm-8">
          <h3 class="productnav1"><asp:Label ID="lblProductType" runat="server" Text=""></asp:Label> 
            <asp:Label ID="lblProductCategory" runat="server" Text=""></asp:Label> 
            <asp:Label ID="lblProductSubCategory" runat="server" Text=""></asp:Label></h3>
              ...
              <div class="col-md-6">
                <div class="show-item right-side float-left-sm">
                  ...
                  <%--<div class="compare float-right-sm">
                    <a href="compare.aspx" class="btn btn-black">Compare <asp:Label ID="lblCompareItem" runat="server" Text=""></asp:Label></a>
                  </div>--%>
                </div>
              </div>
            </div>
