...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.9174731702537!2d77.15034961369791!3d28.692115188135553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d02338c16aaab%3A0xd2d394cf639de66d!2sPitampura+%2C+New+Delhi!5e0!3m2!1sen!2sin!4v1511430414262" 
        ...
        <div class="row m-0">
          <div class="col-sm-4 p-0">
            <div class="contact-box">
              <img src="images/logo.png" class="ctlogo" alt="Palshoes" />
              <%--<span><b>Office</b></span>--%>
              <h5>305 GD-ITL TOWER B-08, NETAJI SUBHASH PLACE, PITAMPURA, NEW DELHI 110034</h5>
            </div>
          </div>
          <div class="col-sm-4 p-0">
            <div class="contact-box">
              ...
              <span><b>Telephone</b></span>
				<h5 class="text-center"><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+91-11-424-64-766">011-42464766</a>,<br />
               <i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+91-88-00-803-806">8800803806</a></h5>
              <p class="text-center">Open<br />Mon – Sat: 9:00 am – 6:00 pm</p>
              <h5>Open<br />Mon – Sat: 9:00 am – 6:00 pm</h5>
            </div>
          </div>
          <div class="col-sm-4 p-0">
            <div class="contact-box">
              <div class="contact-icon contact-mail-icon"></div>
              <span><b>Mail ID</b></span>
              <h5><a href="mailto:info@Palshoes.com">info@Palshoes.com</a></h5>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div name="contactform">
            <div class="col-sm-4 mb-30">
              <input type="text" id="txtname" runat="server" placeholder="Name" name="name" required />
            </div>
            <div class="col-sm-4 mb-30">
              <input type="text" id="txtcontact" runat="server" placeholder="Contact" name="contact" required />
            </div>
            <div class="col-sm-4 mb-30">
              <input type="text" id="txtemailid" runat="server" placeholder="Email" name="email" required />
            </div>
            <div class="col-xs-12 mb-30">
              <textarea placeholder="Message" id="txtmessages" runat="server" rows="3" cols="30" name="message" required></textarea>
            </div>
            <div class="col-xs-12">
              <div class="align-center">
                <asp:Button ID="btnSubmit" CssClass="btn-black" runat="server" Text="Submit" 
