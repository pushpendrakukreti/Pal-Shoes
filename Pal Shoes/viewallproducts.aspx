<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewallproducts.aspx.cs" Inherits="viewallproducts" %>
                ...
                <div class="filter-inner-box mb-20">
                  ...
                  <ItemTemplate>
                    <li>
                      ...
                      <label for="apple-brand"><a href='product.aspx?Brand=<%# Eval("Brand") %>'><%# Eval("Brand")%></a> <span>(<%# Eval("product")%>)</span></label>
                    </li>
                  </ItemTemplate>
                  </asp:Repeater>
                  </ul>--%>
