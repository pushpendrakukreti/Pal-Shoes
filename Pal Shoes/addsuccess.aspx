<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addsuccess.aspx.cs" Inherits="addsuccess" %>
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h2 class="text-center mt-40"><asp:Label ID="lblmessage" runat="server" Text=""></asp:Label></h2>
        </div>
      </div>
    </div>
  </section>
