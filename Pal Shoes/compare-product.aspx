<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compare-product.aspx.cs" Inherits="compare_product" %>
...
<link rel="apple-touch-icon" sizes="114x114" href="images/apple-touch-icon-114x114.html"/>--%>
    ...
    <style type="text/css">
        ...
        .compr td {
            ...
            .compr td:nth-child(1) {
                width: 40%;
            }

            .compr td:nth-child(2) {
                width: 5%;
            }

            .compr td:nth-child(3) {
                width: 55%;
            }
        ...
        <div class="main">
            ...
            <div class="container">
                <div class="bread-crumb mtb-30 center-xs">
                    <div class="page-title">Compare Products</div>
                    <div class="bread-crumb-inner right-side float-none-xs">
                        <ul>
                            <li><a href="Default.aspx">Home</a><i class="fa fa-angle-right"></i></li>
                            <li><a href="compare.aspx"><span>Compare</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <ItemTemplate>
                                        <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
                                            <div class="style_prevu_kit product-item">
                                                <asp:LinkButton ID="removeCompare" CommandArgument='<%# Eval("ProductId") %>' CommandName="Remove"
                                                    OnClick="removeCompare_Click" runat="server">Remove</asp:LinkButton>
