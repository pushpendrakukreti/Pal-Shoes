          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <div class="container">
                <div class="bread-crumb mtb-30 center-xs">
                    <div class="page-title">Order Complete</div>
            ...
            <div class="row">
              <div class="col-sm-8 mb-sm-30">
                              ...
                              <div class="product-info-stock-sku m-0">
                                <div>
                                  ...
                                  <div class="price-box">
                                    ...
                                    <asp:Literal ID="lblprice" runat="server" Text='<%# Bind("ItemSubTotal") %>'></asp:Literal>
                                    <asp:Label ID="lblprice1" runat="server" Text='<%# Bind("ItemPrice") %>' style="display:none"></asp:Label>
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="price-box">
                              <span class="price"><asp:Label ID="lblTotalamount" runat="server" Text=""></asp:Label></span>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td><b>Payment :</b></td>
                          <td><asp:Label ID="lblPaymentmode" runat="server" Text=""></asp:Label></td>
                        </tr>
                        <tr>
                          <td><b>Order No. :</b></td>
                          <td><asp:Label ID="lblOrderNo" runat="server" Text=""></asp:Label></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <div class="mb-30">
                  ...
                  <hr />
                  <p class="mt-20">Your order has placed successfully, You will receive an email confirmation. Your Palshoes product purchase is being processed and will be completed within approximately 3-5 days.</p>
                </div>
                <div class="right-side float-none-xs">
                  <a class="btn btn-black" href="Default.aspx"><span><i class="fa fa-angle-left"></i></span>Continue Shopping</a>
                </div>
              </div>
              <div class="col-sm-4">
