            ...
            <div class="sidebar-box listing-box mb-40">
              ...
              <div class="sidebar-contant">
                <ul>
                 ...
                 <ItemTemplate>
                    <li><a href='product-list.aspx?category=<%# Eval("CategoryId") %>'>
              ...
              <div class="sidebar-contant">
                ...
                <div class="filter-inner-box mb-20">
                  ...
                  <ItemTemplate>
                    <li>
                      ...
                      <label for="apple-brand"><a href='product-list.aspx?Brand=<%# Eval("Brand") %>'><%# Eval("Brand")%></a> <span>(<%# Eval("product")%>)</span></label>
                    </li>
                  </ItemTemplate>
                  </asp:Repeater>
                  </ul>
                ...
                <%--<div class="filter-inner-box mb-20">
                  ...
                  <ItemTemplate>
                    <li>
                      <span><input type="checkbox" class="checkbox" id="Checkbox1" /></span>
                      <label for="apple-brand"><a href='product-list?Flavour=<%# Eval("Producttype") %>'><%# Eval("Producttype")%></a> <span>(<%# Eval("product")%>)</span></label>
                    </li>
                  </ItemTemplate>
                  </asp:Repeater>
                  </ul>
            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                <div class="shop-list-view">
                  <div class="product-item style_prevu_kit">
