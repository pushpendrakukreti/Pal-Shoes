<%@ Page Language="C#" AutoEventWireup="true" CodeFile="term-condition.aspx.cs" Inherits="termandcondition" %>
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h5>Palshoes.com is providing its contents on an "as is" basis and makes no representations or warranties of any kind with respect to this site or its contents. 
          Palshoes.com disclaims all such representations and warranties, including for example warranties of merchantability and fitness for a particular purpose. In addition, 
          Palshoes.com does not represent or warrant that the information accessible via this site is accurate, complete or current.</h5>
          
          <h3 class="mt-20">PAYMENT METHODS USED</h3>
            <h4>We accept the following modes of payments:</h4>
            <h5>&bull; Credit Card</h5>
            <h5>&bull; Debit Card</h5>
            <h5>&bull; Online payment</h5>
            <h5>&bull; Paytm</h5>
            <h3 class="mt-30">GUARANTEE</h3>
            <p>We have a 100% money back guarantee. You can return the entire shipment of Advanced Bionutritionals product within 15 days of purchase and get 100% of your money back, even if you have used up all of the product. You only pay return shipping.</p>
            <h5>SHIPMENT METHOD OPTIONS</h5>
            <p>...</p>
        </div>
      </div>
