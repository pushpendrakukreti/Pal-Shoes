<%@ Page Language="C#" AutoEventWireup="true" CodeFile="event_description.aspx.cs" Inherits="event_description" %>
                                    ...
                                    <ItemTemplate>
                                        <div class="col-xs-12 mb-60">
                                            <div class="blog-media">
                                                <asp:Image ID="complogo" runat="server" ImageUrl='<%# Eval("imagefile","../Upload/event/{0}") %>' />
                                            </div>
