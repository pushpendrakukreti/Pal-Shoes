    ...
    private void BindDefaultProducts()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                firstPageUrl = Link.ToProductOnDefault2("1");
                pagerFormat = Link.ToProductOnDefault2("{0}");
            }
    ...
    private void BindProductBySubcategory(string subcategoryid)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                firstPageUrl = Link.ToProductSubCategory2(subcategoryid, "1");
                pagerFormat = Link.ToProductSubCategory2(subcategoryid, "{0}");
            }
            bottomPager.Show(int.Parse(page), howManyPages, firstPageUrl, pagerFormat, true);
        }
        catch
    ...
    private void BindProductByCategory(string categoryid)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                firstPageUrl = Link.ToProductOnCategory2(categoryid, "1");
                pagerFormat = Link.ToProductOnCategory2(categoryid, "{0}");
            }
            bottomPager.Show(int.Parse(page), howManyPages, firstPageUrl, pagerFormat, true);
        }
        catch
    ...
    private void BindProductByFlavour(string flavour)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                firstPageUrl = Link.ToProductOnFlavour2(flavour, "1");
                pagerFormat = Link.ToProductOnFlavour2(flavour, "{0}");
            }
            bottomPager.Show(int.Parse(page), howManyPages, firstPageUrl, pagerFormat, true);
        }
        catch
    ...
    private void BindProductByBrand(string brand)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                firstPageUrl = Link.ToProductOnBrand2(brand, "1");
                pagerFormat = Link.ToProductOnBrand2(brand, "{0}");
            }
            bottomPager.Show(int.Parse(page), howManyPages, firstPageUrl, pagerFormat, true);
        }
        catch
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (result != 0)
                {
                    ...
                    if (subcategoryid != null)
                    {
                        Response.Redirect("~/product-list.aspx?subcategory=" + subcategoryid + "", false);
                    }
                    else if (categoryid != null)
                    {
                        Response.Redirect("~/product-list.aspx?category=" + categoryid + "", false);
                    }
                    else if (flavour != null)
                    {
                        Response.Redirect("~/product-list.aspx?Flavour=" + flavour + "", false);
                    }
                    else if (brand != null)
                    {
                        Response.Redirect("~/product-list.aspx?Brand=" + brand + "", false);
                    }
                    else
                    {
                        Response.Redirect("~/product-list.aspx", false);
                    }
                }
            }
        }
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (local_orderlist.IsWishlistExist(productid, transid, "N", "") == "F")
                    {
                        ...
                        if (result != 0)
                        {
                            ...
                            if (subcategoryid != null)
                            {
                                Response.Redirect("~/product-list?subcategory=" + subcategoryid + "", false);
                            }
                            else if (categoryid != null)
                            {
                                Response.Redirect("~/product-list?category=" + categoryid + "", false);
                            }
                            else if (flavour != null)
                            {
                                Response.Redirect("~/product-list?Flavour=" + flavour + "", false);
                            }
                            else if (brand != null)
                            {
                                Response.Redirect("~/product-list?Brand=" + brand + "", false);
                            }
                            else
                            {
                                Response.Redirect("~/product-list.aspx", false);
