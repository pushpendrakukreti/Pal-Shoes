            ...
            <div class="col-md-9">
              <div class="top-link right-side">
                <ul>
                  ...
                  <a href="account.aspx" title="My Account"><span></span> My Account</a>
                  </asp:Panel>
                  </li>
              ...
              <div class="main-form full">
                <div class="row">
                  <div class="col-xs-12 mb-20">
                    ...
                    <center><asp:Label ID="lblMessage2" CssClass="message2" runat="server" Text=""></asp:Label></center>
                  </div>
                  <div class="col-sm-6">
                    <div class="input-box">
                  ...
                  <div class="col-sm-6">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ErrorMessage="Invalid EmailId" ControlToValidate="txtEmailid" Display="Dynamic" 
                        ValidationGroup="g1" ForeColor="Red" 
                  ...
                  <div class="col-sm-6">
                    <div class="input-box">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                        ErrorMessage="Mobile No." ControlToValidate="txtMobileno" Display="Dynamic" 
                        ValidationGroup="g1" ForeColor="Red"></asp:RequiredFieldValidator>
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtMobileno"
                            ErrorMessage="Invalid Mobile" ValidationExpression="^[56789]\d{9}$" ValidationGroup="g1"
                  ...
                  <div class="col-sm-6">
                    <div class="input-box">
                      ...
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                        ErrorMessage="Password" ControlToValidate="txtPassword" Display="Dynamic" 
                        ValidationGroup="g1" ForeColor="Red"></asp:RequiredFieldValidator>
                    <!--<asp:RegularExpressionValidator ID="Regex2" runat="server" ControlToValidate="txtPassword"
                        ...
                        ErrorMessage="Minimum 6 Character, 1 Alpha and Number" ForeColor="Red" ValidationGroup="g1" />-->
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="input-box">
                      <label for="re-enter-pass">Re-enter Password</label>
                      <asp:TextBox ID="txtRePassword" runat="server" placeholder="Re-enter Password" 
                            TextMode="Password"></asp:TextBox>
                      <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password Mismatch" 
                        ControlToValidate="txtRePassword" Display="Dynamic" ControlToCompare="txtPassword" 
                        ValidationGroup="g1" ForeColor="Red"></asp:CompareValidator>
                    </div>
                  </div>
                  <div class="col-xs-12">
                    <div class="check-box left-side mb-20">
                      <span>
                        <asp:CheckBox ID="CheckBox1" runat="server" class="checkbox"></asp:CheckBox>
                      </span>
                  ...
                  <div class="col-xs-12">
                    <div class="new-account align-center mt-20">
                      ...
                      <a class="link" title="Login Page" href="login.aspx"><b>Login Here</b></a>
                    </div>
                    <hr />
                  </div>
                ...
                <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
                    ...
                    <div class="body">
                      ...
                      <label runat="server" id="code">Code :</label> <asp:TextBox ID="txtCode" runat="server"></asp:TextBox>
                    </div>
                    <div class="footer1" align="right">
                        <asp:Button ID="btnVerify" runat="server" OnClick="btnVerify_Click" Text="Verify Code" />
                        &nbsp;&nbsp;&nbsp;
