              ...
              <div class="top-link right-side">
                <ul>
                  <li><a style="padding-right: 100px;border-right: none"> </a></li>
                    ...
                    <li><asp:Panel ID="Panel1" runat="server" Visible="true"><a href="wishlist.aspx">
                  <font color="black"><span></span> My Wishlist My Wishlist My Wishlist</font></a></asp:Panel></li>
                ...
                <div class="row">
                  <div class="col-xs-12 mb-20">
                    <div class="heading-part heading-bg">
                      <h2 class="heading" id="guest1" visible="false" runat="server">Customer Login</h2>
                    </div>
                    <center><asp:Button ID="btnGuestLogin" runat="server" Text="Guest User" Visible="false" 
                          class="btn-black text-center" onclick="btnGuestLogin_Click"></asp:Button>
                          </center>
                  </div>
                  <div class="col-xs-12">
                    <asp:Label ID="lblMessage1" runat="server" Text=""></asp:Label>
                    <div class="input-box">
                      <label for="login-email">Email address / Mobile No</label>
                      <asp:TextBox ID="txtUsername" runat="server" placeholder="Email ID"></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ErrorMessage="Email ID" ControlToValidate="txtUsername" Display="Dynamic" 
                  ...
                  <div class="col-xs-12">
                    <div class="check-box left-side">
                      <span>
                        <asp:CheckBox ID="CheckBox1" class="checkbox" runat="server"></asp:CheckBox>
                      </span>
                      <label for="remember_me">Remember Me</label>
                    </div>
                    <asp:Button ID="btnLogin" runat="server" Text="Log In" ValidationGroup="g1" 
                          class="btn-black right-side" onclick="btnLogin_Click"></asp:Button>
                  </div>
                  <div class="col-xs-12">
                    <a title="Forgot Password" class="forgot-password mtb-20" href="forgotpassword.aspx">Forgot your password?</a>
                    <div class="new-account align-center">
                      <span>New to Palshoes?</span>
                      <b><a class="link" title="Register with Pioneer" href="register.aspx">Create New Account</a></b>
                    </div>
                    <hr />
                  </div>
