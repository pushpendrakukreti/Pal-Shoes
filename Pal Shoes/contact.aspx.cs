...
public partial class contact : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            string Myemailid = "info@Palshoes.com";//
            if (Myemailid != null)
            {
                MailMessage mail = new MailMessage();
                mail.From = new MailAddress("noreply@Palshoes.com", "A Query For Palshoes");
                ...
                smtp.Credentials = new System.Net.NetworkCredential("noreply@Palshoes.com", "Tsc7o36&");
