...
<link rel="apple-touch-icon" sizes="114x114" href="images/apple-touch-icon-114x114.html"/>--%>
    ...
    <style type="text/css">
        ...
        .commun-table td .product-title { min-width: 160px;
}
    </style>
</head>
<body>
              ...
              <table class="table">
                ...
                <ItemTemplate>
                  <tr>
                      ...
                      <ul>
                        <li>
                          <div class="base-price price-box">
                            ...
                            <%--<asp:Label ID="lblsprice" runat="server" Text='<%# Bind("sprice") %>' style="display:none"></asp:Label>--%>
                            </span>
                          </div>
                        </li>
                      </ul>
                    ...
                    <td>
                      <div class="input-box">
                          <asp:DropDownList ID="dlqty" runat="server" SelectedValue='<%# Bind("Quantity") %>' 
                                onselectedindexchanged="dlqty_SelectedIndexChanged" DataTextField='<%# Bind("Quantity") %>' 
                                DataValueField='<%# Bind("CartId") %>' AutoPostBack="True" class="quantity_cart">
                    ...
                    <td>
                      <div class="total-price price-box">
                        <span class="price">
                            <asp:Literal ID="lbltotal" runat="server" Text='<%# Bind("totalprice1") %>'></asp:Literal>
                            <asp:Literal ID="lblusdtotal" runat="server" Text='<%# Bind("totalusdprice") %>'></asp:Literal>
                        </span>
                      </div>
                    </td>
                    <td>
                      	<asp:LinkButton ID="LinkButton1" runat="server" 
                            CommandArgument='<%#DataBinder.Eval(Container.DataItem, "CartId")%>' CommandName="Delete">
          ...
          <div class="col-sm-6 mb-xs-40">
            ...
            <div class="estimate">
              <div class="heading-part mb-20">
                <h3 class="sub-heading">Cupon Code Enter Here</h3>
                  <p><asp:Label ID="lblCoupon" runat="server" Text=""></asp:Label> </p>
              </div>
              <div class="full">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="input-box mb-20">
                      <asp:TextBox ID="txtcoupon" Height="35px" placeholder="Enter Your Coupon Code" runat="server"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="* Enter Coupon Code" ControlToValidate="txtCoupon" Display="Dynamic" ValidationGroup="d1" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="input-box mb-20">
                      <asp:Button ID="btnCoupon" CssClass="btn btn-green" runat="server" ValidationGroup="d1"  Text="Apply" OnClick="btnCoupon_Click"></asp:Button>
                    </div>
                  </div>
            ...
            <%--<div class="estimate">
              <div class="heading-part mb-20">
                <h3 class="sub-heading">Check Delivery Available</h3>
              </div>
              <div class="full">
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <div class="input-box mb-20">
                      <asp:Button ID="btnCheckDelivery" CssClass="btn btn-green" runat="server" ValidationGroup="d1" 
                            Text="Check Delivery" onclick="btnCheckDelivery_Click"></asp:Button>
                    </div>
                  </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="price-box">
                          <span class="price"><asp:Label ID="lblTotal" runat="server" Text=""></asp:Label></span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="price-box">
                          <span class="price"><asp:Label ID="lblShippingCost" runat="server" Text=""></asp:Label></span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div class="price-box">
                          <span class="price"><b><asp:Label ID="lblTotal1" runat="server" Text=""></asp:Label></b></span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td><b style="color:#4caf50"><asp:Label ID="lblApplyCoupon" runat="server" Text=""></asp:Label></b></td>
                    </tr>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="mt-30 right-side float-none-xs">
              ...
              <%--<a href="" class="btn btn-black">Proceed to checkout<span><i class="fa fa-angle-right"></i></span></a>--%>
              <asp:LinkButton ID="lnkCheckout" class="btn btn-black" runat="server" 
                   onclick="lnkCheckout_Click">Proceed to checkout<span><i class="fa fa-angle-right"></i></span></asp:LinkButton>
            </div>
          </div>
        </div>
      </div>
